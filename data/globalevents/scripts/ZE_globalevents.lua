...
zeArenaFromPosition = Position(31837, 32427, 7) --pos of top left corner {x = 31837, y = 32427, z = 7}
zeArenaToPosition = Position(31863, 32451, 7) --pos of bottom right corner {x = 31863, y = 32451, z = 7}
...
local function warnEvents(i)
	Game.broadcastMessage("The Zombie event was opened, entrance through Dp of Thais!", MESSAGE_EVENT_ADVANCE)
	if i > 1 then
