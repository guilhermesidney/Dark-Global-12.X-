local TELEPORT_POSITION = Position(32365, 32461, 6)
local TELEPORT_ACTIONID = 45000
local TELEPORT_ITEMID = 1387

local function warnEvent(i)
	Game.broadcastMessage("Battlefield event was opened, a teleport was created in the Event Room (entrance through Dp of Thais)!", MESSAGE_EVENT_ADVANCE)
	if i > 1 then
