local config = {
    teleportId = 1387,
    dias = {
        ["Saturday","Sunday","Mondey","Friday"] = {Position(33649, 31261, 11), Position(33647, 31254, 11)}, -- tanjis

        ["Sunday"] = {Position(33558, 31282, 11), Position(33545, 31263, 11)}, -- jaul


        ["Saturday","Thuersday","Tueasday"] = {Position(33438, 31248, 11), Position(33419, 31255, 11)}, -- obujos
    }
}
