...
if not captureTheFlag then
    ...
    captureTheFlag = {
        ...
        waitingRoom = Position(31856, 32485, 8),
		
		-- Death Room position -- MUDEI AQUI, PROBLEM?
        deathRoom = Position(31854, 32203, 6), 
        ...
        teams = {
            [CTF_TEAM_A] = {
                ...
                base = Position(31773, 32203, 5),
                -- (Modify) Flag, change position and actionid
                flag = Flag:new {position = Position(31773, 32200, 5), id = 8617, actionid = 15150, team = CTF_TEAM_A},
            ...
            [CTF_TEAM_B] = {
                ...
                -- (Modify) Base position (entrance)
                base = Position(31857, 32272, 5),
                -- (Modify) Flag, change position and actionid
                flag = Flag:new {position = Position(31860, 32272, 5), id = 8622, actionid = 15151, team = CTF_TEAM_B},
                -- How many players are in this team
                players = 0,
                -- How many points the team has scored so far
                score = 0
