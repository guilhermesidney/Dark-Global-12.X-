...
SnowBall_Configurations = {
	Event_Duration = 10, -- Minutos de duração do jogo.
	Event_WaitGame = 5, -- Minutos de espera para o inicio do jogo, dentro da sala.
	...
	Area_Configurations = {
		...
		Position_WaitRoom = {x = 31856, y = 32485, z = 8}, -- Posição da sala de espera do jogo
		Position_ExitWaitRoom = {x = 31856, y = 32488, z = 8}, -- Posição do teleport que sairá da sala de espera do jogo
		Position_EventTeleport = {x = 32390, y = 32479, z = 6}, -- Posição de onde será criado o teleport para os participantes irem para a sala de espera.
	},
