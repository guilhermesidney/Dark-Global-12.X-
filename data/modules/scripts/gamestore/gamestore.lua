...
{
	description = "Items espcial from Dark Ot.",
	...
	offers = {
		{
			...
			count = 1,
			number = 1,
			description = "Fast Regen, Arm 3 Slot imbuiment 1",
		...
		},
		{
			...
			count = 30,
			number = 30,
			description = "Use in adventurer guild",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
		},
		{
		...
		},
		{
			...
			count = 10,
			number = 10,
			description = "Use in adventurer Warzone",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
		},
		{
		...
		},
		{
			...
			count = 200,
			number = 200,
			description = "Use it to create umbral",
			type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
		},
		{
			icons = { "Dream_Matter.png" },
			name = "Dream Matter",
			price = 10,
			id = 22397,
			count = 3,
