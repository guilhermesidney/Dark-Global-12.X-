...
local voices = { {text = 'Passages to Issavi, Thais, Carlin, Ab\'Dendriel, Krailos, Port Hope, Edron, Darashia, Liberty Bay, Svargrond, Gray Island, Yalahar and Ankrahmun.'} }
...
addTravelKeyword('issavi', 0, Position(33902, 31462, 6))
